...
if(!pdo_indexexists('tyzm_diamondvote_count',  'indx_uniacid')) {
	pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_count')." ADD KEY `indx_uniacid` (`uniacid`);");
}
if(!pdo_indexexists('tyzm_diamondvote_count',  'indx_rid')) {
	pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_count')." ADD KEY `indx_rid` (`rid`);");
}
...
if(!pdo_fieldexists('tyzm_diamondvote_gift',  'paytype')) {
	pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_gift')." ADD `paytype` varchar(20) NOT NULL COMMENT '支付类型';");
}
...
if(!pdo_fieldexists('tyzm_diamondvote_gift',  'jy')) {
	pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_gift')." ADD `jy` text;");
}
...
if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'votenum')) {
	pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `votenum` int(255) DEFAULT '0' COMMENT '投一票数量';");
}
...
if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'lastvotetime')) {
	pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `lastvotetime` int(10) NOT NULL COMMENT '最新投票时间';");
}
