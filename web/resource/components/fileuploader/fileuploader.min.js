    ...
    return {
        ...
        init: function(o, e) {
            ...
            var l = i.options.type,
                a = i.buildHtml(l);
            return $(document.body).prepend(a), i.modalobj = $("#material-Modal"), i.registerSelected(), angular.module("we7resource").value("config", i.options), angular.bootstrap(i.modalobj, ["we7resource"]), i.modalobj.modal("show"), i.modalobj
        },
        show: function(o, e) {
            this.init(o, e)
        },
        registerSelected: function() {
            ...
            $(window).unbind("resource_selected").on("resource_selected", function(e, i) {
                o.finish(i.items)
            }), $(window).unbind("resource_canceled").on("resource_canceled", function(e, i) {
                o.modalobj.modal("hide")
            })
        },
        finish: function(o) {
            var e = this;
